...
(
	...
	TRANGTHAI bit,
    FOREIGN KEY (MAKH) REFERENCES KHACHHANG (ID_KH) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO KHACHHANG (HOTEN, DIENTHOAI, DIACHI, TICHDIEM) VALUES
(N'Nguyễn Văn Anh', N'0901234567', N'123 Đường A, Quận 1, TP.HCM', 100),
(N'Trần Thị Bảo', N'0912345678', N'456 Đường B, Quận 2, TP.HCM', 200),
(N'Lê Văn Cũi', N'0923456789', N'789 Đường C, Quận 3, TP.HCM', 300),
(N'Phạm Thị Dương', N'0934567890', N'321 Đường D, Quận 4, TP.HCM', 400),
(N'Vũ Văn Vinh', N'0945678901', N'654 Đường E, Quận 5, TP.HCM', 500),
(N'Hoàng Thị Phương', N'0956789012', N'987 Đường F, Quận 6, TP.HCM', 600),
(N'Đỗ Văn Giang', N'0967890123', N'147 Đường G, Quận 7, TP.HCM', 700),
(N'Phùng Thị Hà', N'0978901234', N'258 Đường H, Quận 8, TP.HCM', 800),
(N'Ngô Văn Liệm', N'0989012345', N'369 Đường I, Quận 9, TP.HCM', 900),
(N'Trịnh Thị Khánh', N'0990123456', N'741 Đường K, Quận 10, TP.HCM', 1000);
...
INSERT INTO HOADON (MATAIKHOAN, MAKH, NGAYLAP, TONGTIEN, PHANTRAMGG,TICHDIEM, THANHTIEN, TRANGTHAI) VALUES
(1, 1, '2024-07-12', 190000, 5, 10, 171000, 1),
(2, 2, '2024-07-11', 400000, 10, 20, 320000, 1),
(3, 3, '2024-07-10', 225000, 8, 15, 191250, 1),
(4, 4, '2024-07-09', 360000, 12, 25, 270000, 1),
(5, 5, '2024-07-08', 480000, 15, 30, 336000, 1),
(6, 6, '2024-07-07', 300000, 10, 20, 240000, 1),
(7, 7, '2024-07-06', 420000, 12, 25, 315000, 1),
(8, 8, '2024-07-05', 180000, 5, 10, 162000, 1),
(9, 9, '2024-07-04', 240000, 8, 15, 204000, 1),
(10, 10, '2024-07-03', 150000, 5, 10, 135000, 1);
